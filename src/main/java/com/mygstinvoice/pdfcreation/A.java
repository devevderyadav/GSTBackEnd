...
public class A {
       ...
       /* senderAddress.add(new Paragraph("Address line 2").setFont(font).setFontSize(10));*/
        ...
        sender.addCell(senderAddress);
         ...
         Cell senderRHS = new Cell();
          ...
          senderRHS.add(new Paragraph(InvoiceFormData.getSender().getDateOfInvoice()).setFont(font).setFontSize(12));
          senderRHS.add(new Paragraph("Due Date:").setFont(font).setFontSize(12));
          senderRHS.add(new Paragraph("Balance Due:"+"1000").setFont(font).setTextAlignment(TextAlignment.CENTER).setBackgroundColor(Color.LIGHT_GRAY).setFontSize(14).setHeight(25).setPaddingTop(7).setWidth(200));
   ...
   float total=Float.parseFloat(InvoiceFormData.getInvoiceItemList()[i].getQuantity())*Float.parseFloat(InvoiceFormData.getInvoiceItemList()[i].getRatePerItem());
    float discount = Float.parseFloat(InvoiceFormData.getInvoiceItemList()[i].getDiscount());
    float tax = total*Float.parseFloat(InvoiceFormData.getInvoiceItemList()[i].getTaxRate())/100;
    float totalAfterTax= total-discount+tax;
          ...
          itemCell.setBackgroundColor(Color.WHITE);
          itemCell.setBorder(null);         
          itemCell.add(InvoiceFormData.getInvoiceItemList()[i].getDiscount()).setFont(font).setFontSize(10).setTextAlignment(TextAlignment.CENTER).setFontColor(Color.BLACK);
          itemCell.setVerticalAlignment(VerticalAlignment.MIDDLE);
          itemCell.setHorizontalAlignment(HorizontalAlignment.CENTER);
          listInvoiceItems.addCell( itemCell);
